...
# export CUDA_VISIBLE_DEVICES=2,3;python scripts/rsl_rl/train.py --task=Isaac-Velocity-Flat-Unitree-Go2-v0 --num_env 4096 --headless --experiment_name flat_vels_test_1 --max_iterations 10000 --video

export CUDA_VISIBLE_DEVICES=2;python scripts/rsl_rl/play.py --task=Isaac-Velocity-Flat-Unitree-Go2-v0 --checkpoint logs/rsl_rl/unitree_go2_flat/2025-11-19_19-44-38/model_9999.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless
