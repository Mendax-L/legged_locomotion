...
# export CUDA_VISIBLE_DEVICES=0;python scripts/rsl_rl/train.py --task=Legged-Locomotion-Rough-Unitree-Go2-v0 --num_env 1024 --headless --experiment_name rough --max_iterations 80000 
