...
export CUDA_VISIBLE_DEVICES=0;python scripts/rsl_rl/train.py --task=Legged-Locomotion-Flat-Unitree-Go2-v0 --num_env 4096 --headless --experiment_name flat --max_iterations 100000 --video

# export CUDA_VISIBLE_DEVICES=1;python scripts/rsl_rl/play.py --task=Legged-Locomotion-Flat-Unitree-Go2-v0 --checkpoint logs/rsl_rl/unitree_go2_flat/2025-12-10_16-13-19/model_22850.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless
# export CUDA_VISIBLE_DEVICES=6;python scripts/rsl_rl/play.py --task=Legged-Locomotion-Flat-Unitree-Go2-v0 --checkpoint logs/rsl_rl/unitree_go2_flat/2025-11-19_19-44-38/model_9999.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless
