...
# export CUDA_VISIBLE_DEVICES=2;python scripts/rsl_rl/play.py --task=Legged-Locomotion-Rough-Unitree-Go2-Play-v0  --experiment_name rough --checkpoint logs/rsl_rl/rough/2026-02-04_16-15-32/model_37000.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless
# export CUDA_VISIBLE_DEVICES=3;python scripts/rsl_rl/play.py --task=Legged-Locomotion-Rough-Unitree-Go2-Play-v0  --experiment_name rough --checkpoint logs/rsl_rl/rough/2026-02-04_16-26-08/model_37000.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless



# export CUDA_VISIBLE_DEVICES=0;python -m torch.distributed.run --nnodes=1 --nproc_per_node=2 scripts/rsl_rl/train.py --task=Isaac-Location-Rough-Unitree-Go2-v0 --max_iterations 20000 --num_envs 4096 --video --video_interval 10000 --headless --distributed
...
# export CUDA_VISIBLE_DEVICES=2;python scripts/rsl_rl/play.py --task=Isaac-Location-Rough-Unitree-Go2-v0 --checkpoint logs/rsl_rl/rough_gaits/2025-07-20_22-04-39/model_10000.pt --enable_cameras --video --num_env 512 --video_length 2000 --headless
# export CUDA_VISIBLE_DEVICES=3;python scripts/rsl_rl/train.py --task=Isaac-Location-Flat-Unitree-Go2-v0 --num_env 16384 --headless --experiment_name flat_gaits --max_iterations 100000
